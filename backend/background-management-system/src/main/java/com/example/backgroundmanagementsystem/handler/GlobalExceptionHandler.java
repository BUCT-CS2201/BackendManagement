package com.example.backgroundmanagementsystem.handler;
...
public class GlobalExceptionHandler {
    ...
    public ResponseVO baseExceptionHandler(BaseException baseException){
        ...
        return ResponseUtils.error(baseException.getCode(),baseException.getMsg());
    }
