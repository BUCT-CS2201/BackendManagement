package com.example.backgroundmanagementsystem.aspect;

import com.example.backgroundmanagementsystem.constants.PageQueryAutoFillConstants;
...
public class PageQueryAutoFillAspect {
    @Pointcut("execution(* com.example.backgroundmanagementsystem.controller.*.*(..))&&@annotation(com.example.backgroundmanagementsystem.annotations.PageQueryAutoFill)")
