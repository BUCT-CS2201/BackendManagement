...
import com.example.backgroundmanagementsystem.constants.AutoFillConstants;
...
public class AutoFillAspect {
     ...
     */
    @Pointcut("execution(* com.example.backgroundmanagementsystem.mapper.*.*(..))&&@annotation(com.example.backgroundmanagementsystem.annotations.AutoFill)")
